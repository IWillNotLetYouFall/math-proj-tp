...
//    {
//        // Scaling factor to ensure the results are normalised
//        const float s = 1.0 / sqrtf(contactNormal.z * contactNormal.z + contactNormal.y * contactNormal.y);
//
...
//    Vector3D velocity = thisBody->getRotation() % relativeContactPosition[bodyIndex];
...
//}
//
//void Contact::applyVelocityChange(Vector3D velocityChange[2], Vector3D rotationChange[2])
//{
...
//    Vector3D velKill(desiredDeltaVelocity, -contactVelocity.y, -contactVelocity.z);
//
...
//}
//
//void Contact::applyPositionChange(Vector3D linearChange[2], Vector3D angularChange[2], float penetration)
//{
...
//                            rotationChange[d].vectorProduct(c[i].relativeContactPosition[b]);
//
...
//                            angularChange[d].vectorProduct(c[i].relativeContactPosition[b]);
//
